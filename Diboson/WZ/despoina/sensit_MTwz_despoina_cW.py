...
if not os.path.exists('sensitivityplots_desp_cW/PNG'):
    os.makedirs('sensitivityplots_desp_cW/PNG')
if not os.path.exists('sensitivityplots_desp_cW/PDF'):
    os.makedirs('sensitivityplots_desp_cW/PDF/')
plt.savefig('sensitivityplots_desp_cW/PDF/WZ_atlas_MtWZ_cW.pdf')
plt.savefig('sensitivityplots_desp_cW/PNG/WZ_atlas_MtWZ_cW.png')
# 
# 
# 
# # 
