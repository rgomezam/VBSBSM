...
hist_sm = file_sm[ '/WZ_ATLAS/d08-x01-y01']
...
hist_quad = file_quad ['/WZ_ATLAS/d08-x01-y01']
...
def plot_lin():
    ...
    plt.savefig('sensitivityplots/PDF/WZ_atlas_ptZ.pdf')
    plt.savefig('sensitivityplots/PNG/WZ_atlas_ptZ.png')
# # end def
